var base64 = {
    ...
    encode : function (input) {
        ...
        while (i < input.length) {
            ...
            output = output + this.key_string.charAt(enc1) + this.key_string.charAt(enc2) + this.key_string.charAt(enc3) + this.key_string.charAt(enc4);
        }
        return output;
    },

    // Decoding (Public method) 
...
function bookmarklet() {
    ...
    //hidden_field_2.setAttribute("value", document.body.innerHTML);
    // Base64 encoding - is necessary to prevent blocking by new Chromium browsers (Chrome, Opera...) now :-( 
    // For example, new Chrome browser blocks the process and shows an error message for user... 
    // Simple way for - IE 10+ and other browsers: 
    //hidden_field_2.setAttribute("value", window.btoa(unescape(encodeURIComponent(document.body.innerHTML))));
    // Cross browser way: 
